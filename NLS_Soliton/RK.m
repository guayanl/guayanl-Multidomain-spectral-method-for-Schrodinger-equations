...
B(N1+1,:) = zeros(N1+N2+N3+3,1) ;
B(N1+2,:) = zeros(N1+N2+N3+3,1) ;
B(N1+N2+2,:) = zeros(N1+N2+N3+3,1) ;
B(N1+N2+3,:) = zeros(N1+N2+N3+3,1) ;

B(N1+1,N1+1) = 1 ;B(N1+1,N1+2) = -1;
B(N1+2,1:N1+N2+2) = [2/x_L*D1(end,:) , -2/(x_L-x_R)*D2(1,:)];
B(N1+N2+2,N1+N2+2) = 1 ;B(N1+N2+2,N1+N2+3) = -1;
